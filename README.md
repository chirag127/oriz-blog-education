# Education — `oriz-blog-education`

> Learning that sticks — study methods, subjects, and the craft of understanding.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-education?style=flat)](https://github.com/chirag127/oriz-blog-education/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-education)](https://github.com/chirag127/oriz-blog-education/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-education/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-education/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Education** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
An education blog on study methods, subject explainers, and lifelong learning — how to actually understand and retain things.

- **Live site:** https://education-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-education
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-education/ — the canonical, always-current site is **https://education-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-education/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>education-blog.oriz.in"]
...
oriz-blog-education/
├── src/
│   ├── content/blog/       # the study guides (MDX/Markdown)
